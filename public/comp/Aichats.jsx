          ...
          {parts.map((part, index) => {
            ...
            return (
              <ReactMarkdown
                ...
                components={{
                  p: ({node, ...props}) => <p className="whitespace-pre-wrap text-gray-100" {...props} />,
                  ul: ({node, ...props}) => <ul className="list-disc pl-5 my-2 text-gray-100" {...props} />,
                  ol: ({node, ...props}) => <ol className="list-decimal pl-5 my-2 text-gray-100" {...props} />,
                  li: ({node, ...props}) => <li className="my-1 text-gray-100" {...props} />,
